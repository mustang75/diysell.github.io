...
<?php endif; ?>
	<table class="category">
		...
		<thead><tr>
			...
			<th class="item-title">
        <?php if($version->RELEASE == 1.6)
			{
				echo JHtml::_('grid.sort', 'COM_CONTACT_CONTACT_EMAIL_NAME', 'a.name', $listDirn, $listOrder); 
			}
			else
			{
				echo JHtml::_('grid.sort', 'COM_CONTACT_CONTACT_EMAIL_NAME_LABEL', 'a.name', $listDirn, $listOrder);
			}
			?>
			</th>

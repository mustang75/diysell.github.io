...
<form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
		...
		<?php endif; ?>
			...
			<button class="btn btn-default" type="button" onclick="Joomla.submitbutton('article.save')">
				<?php echo JText::_('JSAVE') ?>
			</button>
			<button class="btn btn-default" type="button" onclick="Joomla.submitbutton('article.cancel')">

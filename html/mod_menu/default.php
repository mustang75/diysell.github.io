...
echo '<hr class="separator" /><ul role="menu" class="dropdown-menu sub-menu"id="dropdown-menu">';
}
}
...
if ($item->deeper) {
if($item->level==$start){
echo '<hr class="horiz_separator" /><ul role="menu" class="child dropdown-menu"id="dropdown-menu">';
	}
else{
echo '<hr class="separator" /><ul role="menu" class="dropdown-menu sub-menu" id="dropdown-menu">';
}
